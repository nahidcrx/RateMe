...
module.exports = (app) => {
    ...
    app.post('/message/:id',isLoggedIn, (req, res) => {
        ...
        User.findOne({'_id': req.params.id}, (err, data) => {
            ...
            if(data.image === ''){
                newMessage.userFromImage= 'Default_Profile.png';
            }else{
               newMessage.userFromImage = data.image; 
            }
            
            if(req.user.image === ''){
                newMessage.userToImage = 'Default_Profile.png';
            }else{
                newMessage.userToImage = req.user.image;
            }
