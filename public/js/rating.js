$(document).ready(function(){
    ...
    $('#rate').on('click', function(){
        ...
        if(clickedValue === 0 || clickedValue > 5){
            valid = false;
            $('#error').html('<div class="alert alert-dnger">Please click on rating before you submit.</div>');
        }else if(review.length === 0){
            valid = false;
            $('#error').html('<div class="alert alert-dnger">Please give a review before you submit.</div>');
